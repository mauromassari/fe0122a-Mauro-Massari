...
var giocatore = Math.abs(Math.floor((Math.random() * (100 - 1) + 1)));
var giocatore_2 = Math.abs(Math.floor((Math.random() * (100 - 1) + 1)));
var generatoreNumero = Math.abs(Math.floor((Math.random() * (100 - 1) + 1)));
var tolleranzaUp = Math.abs(generatoreNumero + 10);
var tolleranzaDown = Math.abs(generatoreNumero - 10);
console.log("È uscito il numero: " + generatoreNumero);
console.log("\u00C8 concessa una tolleranza compresa fra ".concat(tolleranzaDown, "  e ").concat(tolleranzaUp));
